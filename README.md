...
print(date1.isSameDecade(date2));       // true (same decade, 2020s)
...
print(date1.isCurrentDecade);      // true (is current decade, 2020s)
...
print(date.isStartOfDecade);      // false (not January 1, 2020 00:00:00)
...
print(date.isEndOfDecade);        // false (not December 31, 2029 23:59:59.999)
...
print(date.microsecondOfDecade);      // 131380245500750 (microseconds in decade)
...
print(date.millisecondOfDecade);      // 131625645500 (milliseconds in decade)
...
print(date.secondOfDecade);           // 131625645 (seconds in decade)
...
print(date.minuteOfDecade);           // 2194560 (minutes in decade)
...
print(date.hourOfDecade);             // 36574 (hours in decade)
...
print(date.dayOfDecade);              // 1521 (1521st day of decade)
