...
print(date1.isSameDecade(date2));       // true (同十年，2020年代)
...
print(date1.isCurrentDecade);      // true (是否為當前十年，2020年代)
...
print(date.isStartOfDecade);      // false (不是2020年1月1日00:00:00)
...
print(date.isEndOfDecade);        // false (不是2029年12月31日23:59:59.999)
...
print(date.microsecondOfDecade);      // 131380245500750 (十年中微秒數)
...
print(date.millisecondOfDecade);      // 131625645500 (十年中毫秒數)
...
print(date.secondOfDecade);           // 131625645 (十年中秒數)
...
print(date.minuteOfDecade);           // 2194560 (十年中分鐘數)
...
print(date.hourOfDecade);             // 36574 (十年中小時數)
...
print(date.dayOfDecade);              // 1521 (十年中第1521天)
...
// 年級位置
print(date.yearOfDecade);             // 5 (十年中第5年，2024在2020年代)
...
print(date.minutesInDecade);           // 5260320 (2020年代分鐘數)
...
print(date.hoursInDecade);             // 87672 (2020年代小時數)
...
print(date.daysInDecade);              // 3653 (2020年代天數)
